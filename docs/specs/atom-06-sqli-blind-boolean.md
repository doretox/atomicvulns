...
**Tipo de átomo:** com HTML (`templates/index.html` para o form + `templates/result.html` mostrando uma das duas mensagens). O HTML existe pelo motivo padrão: deixar o aluno ver a feature uma vez no browser antes de migrar pro Burp.
